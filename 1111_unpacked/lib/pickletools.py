...
# Embedded file name: Lib\pickletools.py
# Compiled at: 2013-10-27 19:00:18
...
class ArgumentDescriptor(object):
    ...
    def __init__(self, name, n, reader, doc):
        ...
        self.name = name
        assert isinstance(n, int) and (n >= 0 or n in (UP_TO_NEWLINE,
...
opcodes = [
 ...
 I(name='LONG1', code=b'\x8a', arg=long1, stack_before=[], stack_after=[
  pylong], proto=2, doc='Long integer using one-byte length.\n\n      A more efficient encoding of a Python long; the long1 encoding\n      says it all.'),
 I(name='LONG4', code=b'\x8b', arg=long4, stack_before=[], stack_after=[
 ...
 I(name='TUPLE1', code=b'\x85', arg=None, stack_before=[
 ...
 I(name='TUPLE2', code=b'\x86', arg=None, stack_before=[
 ...
 I(name='TUPLE3', code=b'\x87', arg=None, stack_before=[
 ...
 I(name='EXT1', code=b'\x82', arg=uint1, stack_before=[], stack_after=[
 ...
 I(name='EXT2', code=b'\x83', arg=uint2, stack_before=[], stack_after=[
  anyobject], proto=2, doc='Extension code.\n\n      See EXT1.  EXT2 has a two-byte integer argument.\n      '),
 I(name='EXT4', code=b'\x84', arg=int4, stack_before=[], stack_after=[
 ...
 I(name='NEWOBJ', code=b'\x81', arg=None, stack_before=[
  anyobject, anyobject], stack_after=[
  anyobject], proto=2, doc='Build an object instance.\n\n      The stack before should be thought of as containing a class\n      object followed by an argument tuple (the tuple being the stack\n      top).  Call these cls and args.  They are popped off the stack,\n      and the value returned by cls.__new__(cls, *args) is pushed back\n      onto the stack.\n      '),
 I(name='PROTO', code=b'\x80', arg=uint1, stack_before=[], stack_after=[], proto=2, doc='Protocol version indicator.\n\n      For protocol 2 and above, a pickle must start with this opcode.\n      The argument is the protocol version, an int in range(2, 256).\n      '),
        ...
        if markobject in before or opcode.name == 'POP' and stack and stack[-1] is markobject:
            ...
            if opcode.name in ('PUT', 'BINPUT', 'LONG_BINPUT'):
                ...
                if arg in memo:
                    ...
                    errormsg = stack or "stack is empty -- can't store into memo"
